...
for sigma=sigma_min:sigma_inc:sigma_max
    ...
    for nbSegments=nbSegments_min:nbSegments_inc:nbSegments_max
        ...
        for m=m_min:m_inc:m_max
            ...
            J = I;
            for i=1:3
                [noise, PS] = emnoise(I(:,:,i), alpha, sigma_0, 0);
                J(:,:,i) = J(:,:,i) + noise;
                noise_3d(:,:,i) = noise;
                PS_3d(:,:,i) = PS;
            end
...
%% Save results
str_noise_output = strcat('Q_noise_nlmss_',num2str(sigma_min),'_',num2str(sigma_inc),'_',num2str(sigma_max),'_',num2str(nbSegments_min),'_',num2str(nbSegments_inc),'_',num2str(nbSegments_max),'_',num2str(m_min),'_',num2str(m_inc),'_',num2str(m_max));
save(strcat(str_noise_output,'.mat'),'Q_noise');
str_denoised_output = strcat('Q_denoised_nlmss_',num2str(sigma_min),'_',num2str(sigma_inc),'_',num2str(sigma_max),'_',num2str(nbSegments_min),'_',num2str(nbSegments_inc),'_',num2str(nbSegments_max),'_',num2str(m_min),'_',num2str(m_inc),'_',num2str(m_max));
