...
%% Save results
str_noise_output = strcat('Q_noise_nlmsc_',num2str(sigma_min),'_',num2str(sigma_inc),'_',num2str(sigma_max),'_',num2str(nbSegments_min),'_',num2str(nbSegments_inc),'_',num2str(nbSegments_max),'_',num2str(m_min),'_',num2str(m_inc),'_',num2str(m_max));
save(strcat(str_noise_output,'.mat'),'Q_noise');
str_denoised_output = strcat('Q_denoised_nlmsc_',num2str(sigma_min),'_',num2str(sigma_inc),'_',num2str(sigma_max),'_',num2str(nbSegments_min),'_',num2str(nbSegments_inc),'_',num2str(nbSegments_max),'_',num2str(m_min),'_',num2str(m_inc),'_',num2str(m_max));
